...
<div align="center">
  ...
  ![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=28&pause=1000&color=6C63FF&center=true&vCenter=true&width=600&lines=Desarrollador+Web+Frontend;Apasionado+por+la+Ciberseguridad)
...
### Aprendiendo
![Cybersecurity](https://img.shields.io/badge/Ciberseguridad-000000?style=for-the-badge&logo=hackaday&logoColor=white)
...
```python
intereses = {
    "desarrollo_web": ["Vue.js", "JavaScript", "Frontend"],
    "backend": ["Python", "APIs"],
    "seguridad": ["Ciberseguridad", "Ethical Hacking"],
    "otros": ["Matemáticas aplicadas", "Algoritmos"]
}
```
...
<div align="center">
  ...
  ![Visitantes](https://visitor-badge.laobi.icu/badge?page_id=runer0101.runer0101)
  
  ⭐ From [runer0101](https://github.com/runer0101)
